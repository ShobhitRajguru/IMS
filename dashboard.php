...
<div class="container">
    ...
    <div class="buttons">
        ...
        <button onclick="location.href='http://localhost:5000/masterform';" class="btn">Import Components</button>
...
<script>
    ...
    var categoryCounts = <?php
        ...
        $lab = $_SESSION['lab_no'];
        $sql = "SELECT category, COUNT(*) AS total_entries FROM components WHERE location = $lab GROUP BY category";
    ...
    const capacityLimits = {
        ...
        DMM: 20,
        KIT: 20,
        FUNCTION_GENERATOR: 4 // Note: corrected "BORADS" to "BOARDS"
    };
